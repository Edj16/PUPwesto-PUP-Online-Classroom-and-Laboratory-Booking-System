...
try {
    ...
    if ($user_data) {
        ...
        $_SESSION['contact'] = $user_data['contact_num'];
        $_SESSION['program'] = $user_data['program'];
                ...
                <?php
                  $sql = "
                      SELECT 
                          ...
                          u.contact_num
                      FROM reservation r
                      LEFT JOIN room rm ON BINARY r.room_number = BINARY rm.room_number
        ...
        <div class="profile-container">
          <div class="profile-wrapper">
            <div class="profile-wrapper2">
              <div class="row-div">
                <h6><i class="fas fa-user-circle"></i> User Profile</h6>
              </div>
              <img src="../images/profile-placeholder.png" alt="profile" id="profile-pic">
              <div class="row-div">
                <form action="">
                  <label for="user-name"><i class="fas fa-user"></i></label>
                  <input type="text" name="user-name" id="user-name" value="<?php echo htmlspecialchars($_SESSION['name']); ?>" readonly>
                </form>
              </div>
            </div>
            ...
            <div class="form-wrapper">
              <form action="">
                <div class="col-div">
                  <label for="user-id"><i class="fas fa-id-badge"></i> User ID</label>
                  <input type="text" name="user-id" id="user-id" value="<?php echo htmlspecialchars($_SESSION['user_id']); ?>" readonly>
                </div>

                <div class="row-div">
                  <div class="col-div">
                    <label for="user-program"><i class="fas fa-graduation-cap"></i> Program</label>
                    <input type="text" name="user-program" id="user-program" value="<?php echo htmlspecialchars($_SESSION['program']); ?>" readonly>
                  </div>

                  <div class="col-div">
                    <label for="user-block"><i class="fas fa-th-large"></i> Block</label>
                    <input type="text" name="user-block" id="user-block" value="<?php echo htmlspecialchars($_SESSION['block']); ?>" readonly>
                  </div>

                  <div class="col-div">
                    <label for="user-section"><i class="fas fa-users"></i> Section</label>
                    <input type="text" name="user-section" id="user-section" value="<?php echo htmlspecialchars($_SESSION['section']); ?>" readonly>
                  </div>
                </div>

                <div class="row-div">
                  <div class="col-div">
                    <label for="user-contact"><i class="fas fa-phone"></i> Contact</label>
                    <input type="text" name="user-contact" id="user-contact" value="<?php echo htmlspecialchars($_SESSION['contact']); ?>" readonly>
                  </div>

                  <div class="col-div">
                    <label for="user-email"><i class="fas fa-envelope"></i> E-mail</label>
                    <input type="email" name="user-email" id="user-email" value="<?php echo htmlspecialchars($_SESSION['email']); ?>" readonly>
                  </div>
                </div>

                <div class="col-div">
                  <label for="user-department"><i class="fas fa-building"></i> Department</label>
                  <input type="text" name="user-department" id="user-department" value="<?php echo htmlspecialchars($_SESSION['department'] ?? ''); ?>" readonly>
                </div>

                <div class="col-div">
                  <label for="user-role"><i class="fas fa-user-tag"></i> Role</label>
                  <input type="text" name="user-role" id="user-role" value="<?php echo htmlspecialchars($_SESSION['user_role']); ?>" readonly>
                </div>

                <div class="button-row-div">
                  <button type="button" class="edit-btn" id="edit-profile-btn"><i class="fas fa-edit"></i> Edit</button>
                  <button type="button" class="save-btn" id="save-profile-btn" style="display: none;"><i class="fas fa-save"></i> Save</button>
    ...
    .then(rooms => {
        ...
        rooms.forEach(room => {
            ...
            roomDiv.innerHTML = `
                ...
                <button class="select-room-btn" data-room-number="${roomNumber}" data-room-type="${type}" data-building="${building}">Select Room</button>
            `;
        ...
        document.querySelectorAll('.select-room-btn').forEach(button => {
            button.addEventListener('click', function() {
                const selectedRoom = this.getAttribute('data-room-number');
                ...
                if (selectedRoom && selectedRoom !== 'N/A') {
                    ...
                    document.getElementById('selected-room').dataset.roomType = roomType;
                    document.getElementById('selected-room').dataset.building = building;
...
function submitReservationToBackend() {
    ...
    const data = {
        ...
        room_number: selectedRoomElement.value,
        room_type: selectedRoomElement.dataset.roomType,
        building: selectedRoomElement.dataset.building,
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const inputs = form.querySelectorAll('input:not([name="user-id"]):not([name="user-role"])');
